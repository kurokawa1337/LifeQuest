 ...
 //МОДЕЛІ ДАНИХ 
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                switch (choice)
                {
                    ...
                    case "7": HardReset(); break; // НОВА ФУНКЦІЯ
        ...
        static void HardReset()
        {
            ...
            {
                // 1. Очищаємо дані в оперативній пам'яті
                tasks.Clear();
                player = new UserProfile();

                // 2. Фізично видаляємо файли з диска
        ...
        // ДОПОМІЖНІ МЕТОДИ (Збереження та Утиліти)
